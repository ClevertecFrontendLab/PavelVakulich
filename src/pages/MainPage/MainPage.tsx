                    ...
                    <Col span={24}>
                        <Card className={styles.card_actions}>
                            <p>
                                ...
                                <br />— планировать свои тренировки на&nbsp;календаре, выбирая тип
                                и&nbsp;уровень нагрузки;
                                <br />— отслеживать свои достижения в&nbsp;разделе статистики,
                                сравнивая свои результаты с&nbsp;нормами и&nbsp;рекордами;
                                <br />— создавать свой профиль, где ты&nbsp;можешь загружать свои
                            ...
                            <Col xs={24} span={24}>
                                <Card bordered={false} className={styles.card_info}>
                                    <p className={styles.card_description}>
                                        CleverFit&nbsp;— это не&nbsp;просто приложение, а&nbsp;твой
                                        личный помощник в&nbsp;мире фитнеса. Не&nbsp;откладывай
                                        на&nbsp;завтра&nbsp;— начни тренироваться уже сегодня!
                                    </p>
                                </Card>
                            </Col>
                            <Col span={24}>
